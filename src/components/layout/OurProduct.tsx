  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden rounded-[30px]">
        <img
          className="h-[350px] sm:h-[420px] md:h-[500px] w-full object-cover group-hover:scale-105 transition-all duration-700 ease-in-out"
          loading="lazy"
      ...
      <div className="flex flex-col gap-[7px] justify-between">
        <h3 className="text-[28px] sm:text-[32px] text-text-base font-bold">
          {productData.productName}
        </h3>
        <p className="text-[16px] sm:text-[18px] leading-[150%] text-text-secondary font-normal w-[95%]">
  ...
  return (
    ...
    >
      <motion.div variants={fadeInUp}>
        ...
        <p className="text-[18px] sm:text-[22px] font-normal leading-[150%] text-text-secondary w-full md:w-2/3">
