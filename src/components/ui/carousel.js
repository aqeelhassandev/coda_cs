...
function CarouselContent({ className, ...props }) {
    ...
    return (_jsx("div", { ref: carouselRef, className: "overflow-hidden h-full", "data-slot": "carousel-content", children: _jsx("div", { className: cn("flex", orientation === "horizontal" ? "-ml-4" : "-mt-4 flex-col", className), ...props }) }));
}
...
function CarouselPrevious({ className, variant = "outline", size = "icon-sm", ...props }) {
    ...
    return (_jsxs(Button, { "data-slot": "carousel-previous", variant: variant, size: size, className: cn("absolute touch-manipulation rounded-full", orientation === "horizontal"
            ...
            : "-top-12 left-1/2 -translate-x-1/2 rotate-90", className), disabled: !canScrollPrev, onClick: scrollPrev, ...props, children: [_jsx(HugeiconsIcon, { icon: ArrowLeft01Icon, strokeWidth: 2 }), _jsx("span", { className: "sr-only", children: "Previous slide" })] }));
}
function CarouselNext({ className, variant = "outline", size = "icon-sm", ...props }) {
    ...
    return (_jsxs(Button, { "data-slot": "carousel-next", variant: variant, size: size, className: cn("absolute touch-manipulation rounded-full", orientation === "horizontal"
            ...
            : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90", className), disabled: !canScrollNext, onClick: scrollNext, ...props, children: [_jsx(HugeiconsIcon, { icon: ArrowRight01Icon, strokeWidth: 2 }), _jsx("span", { className: "sr-only", children: "Next slide" })] }));
}
